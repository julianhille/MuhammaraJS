...
| `README.md`                       | Migrated                      | Installation, migration, and compatibility source material.    |
| `CHANGELOG.md`                    | Canonical at repository root  | Current release history.                                       |
| `lib/Recipe.js` and `lib/recipe/` | Primary implementation source | High-level Recipe behavior.                                    |
| `muhammara.d.ts`                  | Secondary source              | Public TypeScript surface to reconcile with implementation.    |
| `tests/`                          | Primary verification source   | Executable behavior and example candidates.                    |
