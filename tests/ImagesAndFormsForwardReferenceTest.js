...
describe('ImagesAndFormsForwardReferenceTest', function() {
	it('should complete without error', function() {
		...
		pdfWriter.createImageXObjectFromJPG(__dirname+'/TestMaterials/images/otherStage.JPG',imageXObjectID);
		pdfWriter.createFormXObjectFromJPG(__dirname+'/TestMaterials/images/otherStage.JPG',formXObjectID);
		pdfWriter.createFormXObjectFromTIFF(__dirname+'/TestMaterials/images/tiff/jim___ah.tif',tiffFormXObjectID);
