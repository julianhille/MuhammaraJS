...
describe('ShutDownRestartState', function() {
	it('should complete without error', function() {
		...
		pdfWriterA.startPageContentContext(page)
			.q()
			.k(100,0,0,0)
			.re(100,500,100,100)
			.f()
		...
		pdfWriterA.writePage(page).shutdown(__dirname + '/output/ShutDownRestartState.txt');
		...
		var contentContext = pdfWriterB.startPageContentContext(page)
			.q()
			.k(100,0,0,0)
			.re(100,500,100,100)
			.f()
