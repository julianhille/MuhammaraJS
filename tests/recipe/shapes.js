...
describe("Regular Polygons, Stars, Arrows", () => {
  it("Add N sided regular polygons", (done) => {
    ...
    recipe
      ...
      .n_gon(200, 220, 50, 6, { opacity: 0.3, rotation: 30, debug: 1 })
  ...
  it("Add N pointed stars", (done) => {
    ...
    recipe
      ...
      .star(200, 450, 50, 7)
      .star(300, 450, 50, 8, { fill: "#0000ff", opacity: 0.3 })
      .star(400, 450, 50, 9, { fill: "#0000ff", opacity: 0.3 })
      .star(200, 560, 50, 10, { fill: "#0000ff", opacity: 0.3 })
      .star(300, 560, 50, 11, { fill: "#0000ff", opacity: 0.3 })
      .star(400, 560, 50, 40)
      .endPage()
      .endPDF(done);
  });
  ...
  it("Add arrows", (done) => {
    ...
    let hl = 100;
    recipe
      .circle(cx, cy, hw, { color: "green", width: 0.5 })
      .arrow(cx, cy, { shaft: sw, head: hw })
      .text("(x,y)", cx - 22, cy - 15, {
        size: 9,
        color: "#000000",
        bold: true,
      })
    ...
    recipe
      .text("Usage: recipe.arrow( x, y, [options] );", ux, uh, {
        bold: true,
        size: 10,
        color: "#000000",
      })
      ...
      .text('position\nand rotate\nat "tail"', 40, 270, {
        size: 9,
        textBox: { width: 50, textAlign: "center" },
      })
      .text('position\nand rotate\nat "head"', 135, 250, {
        size: 9,
        textBox: { width: 50, textAlign: "center" },
