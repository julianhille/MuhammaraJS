...
describe("Triangles", () => {
  it("SSS, SAS, ASA", (done) => {
    ...
    recipe
      ...
      .triangle(x + 200, y, [40, 80, 50], {
        traitID: "asa",
        width: 0.5,
        color: "blue",
        debug: true,
      })
      .triangle(x + 350, y, [40, 80, 50], {
        traitID: "asa",
        width: 0.5,
        position: "c",
        flipX: true,
