...
| `OpenSSL`          | [3.5.4](https://github.com/openssl/openssl/releases/tag/openssl-3.5.4)   | Source bundled as `native-with-source/src/deps/openssl-3.5.4.tar.gz`, compiled by GYP into ignored architecture-specific `openssl-build/` output, then statically linked; [source](https://github.com/openssl/openssl) |
