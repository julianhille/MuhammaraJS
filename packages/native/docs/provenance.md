...
| `packages/native/README.md`                       | Migrated                      | Installation, migration, and compatibility source material.    |
| `CHANGELOG.md`                                    | Canonical at repository root  | Current release history.                                       |
| `packages/native/lib/Recipe.js` and `lib/recipe/` | Primary implementation source | High-level Recipe behavior.                                    |
| `packages/native/muhammara.d.ts`                  | Secondary source              | Public TypeScript surface to reconcile with implementation.    |
| `packages/native/tests/`                          | Primary verification source   | Executable behavior and example candidates.                    |
