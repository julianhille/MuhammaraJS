...
- Add `Recipe.HorizontalAlign`, `Recipe.VerticalAlign`, `Recipe.FontStyle`, `Recipe.Permission`, `Recipe.Coordinate`, `Recipe.Colorspace`, `Recipe.AnnotSubtype`, `Recipe.AnnotFlag` and
